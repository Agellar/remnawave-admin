...
- Compatibility rechecked against Remnawave Admin `4.7.2`: `2026-09-08`
...
- a 30-second upper clock-skew bound on activity/history fallbacks, so
  pre-4.7.2 future-shifted rows cannot masquerade as current activity;
