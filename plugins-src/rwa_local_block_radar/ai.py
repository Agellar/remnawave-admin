...
- Сырые события nDPI/BitTorrent не доказывают ни нарушение пользователя, ни сетевую блокировку. Admin 4.7.1 учитывает разные адреса пиров (torrent_min_peers) и белый список владельцев ASN (torrent_asn_whitelist), а Node Agent 1.8.0 усиливает фильтр портов. Повторы к одному адресу, легальные P2P-обновления и аннулированные нарушения нельзя считать доказательством виновности или рецидива. Действующие значения настроек не угадывай по умолчаниям.
